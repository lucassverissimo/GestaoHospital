...
namespace GestaoHospital.WebAPI.Data
{
    public class Repository : IRepository
    {
        ...
        public Repository(GHContext context)
        {
            _context = context;
        }
        ...
        public async Task<(List<Mapa>,int)> GetAllMapasAsync(RequestData<GetMapasFilterDto> request)
        {
            ...
            query = query.Include(o => o.Paciente)
